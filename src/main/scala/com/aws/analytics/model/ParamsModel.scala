...
object ParamsModel {
  ...
  case class MySQLCDC2MSKParams(projectEnv:String,disableChaining:String,  deliveryGuarantee:String,host:String,username:String,
                           ...
                           serverId:String,serverTimeZone:String,kafkaBroker:String,topic:String,topicPrefix:String,tablePK:String,kafkaProperties:String)
  ...
  case class MySQLCDC2MSKParamsForEMR(projectEnv: String, disableChaining: String, deliveryGuarantee: String, host: String, username: String,
                                password: String, position: String, dbList: String, tbList: String,
                                serverId: String, serverTimeZone: String, kafkaBroker: String, topic: String, topicPrefix: String, tablePK: String,checkpointInterval :String,checkpointDir:String,parallel:String,kafkaProperties:String)
